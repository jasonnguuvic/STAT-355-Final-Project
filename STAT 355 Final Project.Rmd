...
fontsize: 11pt
---
#abc Setting up Google Drive


Instructions: https://github.com/ekothe/trackdown


Install the remotes packages and run the code provided to you in the above link. Doing this allows you to update and/or download the shared document. ALWAYS SAVE YOUR R MARKDOWN FILE BEFORE UPDATING THE DRIVE
```{r Download Drive}
"Run this chunk. If it doesn't work,copy and paste the code into your console and run."
library(trackdown)
download_rmd(file = "STAT 355 Final Project", 
             gfile = "STAT 355 Final Project")
```
...
"Run this chunk. If it doesn't work,copy and paste the code into your console and run."
library(trackdown)
update_rmd(file = "STAT 355 Final Project", 
           gfile = "STAT 355 Final Project")
```
